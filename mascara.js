...
var _user$project$Main$creditPage = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$id('primary'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
...
var _user$project$Main$page = function (model) {
	...
	switch (_p0.ctor) {
		...
		case 'PageRoute':
			...
			switch (_p1) {
				case 'sample':
					return _user$project$Main$samplePage;
				case 'credits':
					return _user$project$Main$creditPage;
				default:
					return A2(_user$project$Main$loadPage, model, _p2);
			}
		default:
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('inside container'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('h6 mb0'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$span,
										{
											...
											_0: A2(
												_elm_lang$html$Html_Attributes$property,
												'innerHTML',
												_elm_lang$core$Json_Encode$string('&copy;')),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {
...
var _user$project$Main$siteLinks = {
	ctor: '::',
	_0: {url: '#mining', title: 'Mining'},
	_1: {
		ctor: '::',
		_0: {url: '#algorithms', title: 'Algorithms'},
		_1: {
			ctor: '::',
			_0: {url: '#science', title: 'Science'},
			_1: {
				ctor: '::',
				_0: {url: '#curation', title: 'Curation'},
				_1: {
					ctor: '::',
					_0: {url: '#analytics', title: 'Realtime-Analytics'},
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Main$metaMenu = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('inside'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Data MASCARA'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('topics'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('acronym'),
												_1: {ctor: '[]'}
											}
										},
										{
														...
														return A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(s.title),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															});
													},
													_user$project$Main$siteLinks)),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$home = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('back home'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('h6'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$metaMenu,
			_1: {
				ctor: '::',
				_0: _user$project$Main$page(model),
				_1: {
					ctor: '::',
					_0: _user$project$Main$footerMenu,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$initialModel = F2(
	function (flags, route) {
		return {route: route, errorMessage: ''};
	});
var _user$project$Main$Model = F2(
	function (a, b) {
		return {route: a, errorMessage: b};
	});
...
var _user$project$Main$PageRoute = function (a) {
	return {ctor: 'PageRoute', _0: a};
};
var _user$project$Main$SectionRoute = {ctor: 'SectionRoute'};
var _user$project$Main$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Main$SectionRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Main$PageRoute, _evancz$url_parser$UrlParser$string),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$parseLocation = function (location) {
	var _p3 = A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Main$matchers, location);
	if (_p3.ctor === 'Just') {
		return _p3._0;
	} else {
...
var _user$project$Main$init = F2(
	function (flags, location) {
		...
		return {
			ctor: '_Tuple2',
			_0: A2(_user$project$Main$initialModel, flags, currentRoute),
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p4.ctor === 'OnLocationChange') {
			var newRoute = _user$project$Main$parseLocation(_p4._0);
			return {
				ctor: '_Tuple2',
			...
			return {
				...
				_1: _elm_lang$navigation$Navigation$newUrl(
					A2(_elm_lang$core$Basics_ops['++'], '#cat/', _p4._0))
			};
		}
	});
var _user$project$Main$ShowCat = function (a) {
	return {ctor: 'ShowCat', _0: a};
};
